 ...
 * Declaration of pack/unpack functions for the CAN frames of cluster arduinoSampleIntegration.
 *
...
/** The minimum of the world value of signal checksum of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_CHECKSUM_MIN	(0)

/** The maximum of the world value of signal checksum of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_CHECKSUM_MAX	(255)


/** Convert the binary value of signal speedOfRotation of frame StateEcu01 (1024, 0x400)
    as received via the CAN interface into the world value. */
#define PCK_PT_1024_SPEEDOFROTATION_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_1024_SPEEDOFROTATION_FACTOR+PCK_PT_1024_SPEEDOFROTATION_OFFSET)

/** Convert the world value of signal speedOfRotation of frame StateEcu01 (1024, 0x400)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_1024_SPEEDOFROTATION_FLT_TO_BIN(flt) \
            ((uint16_t)(((flt)-PCK_PT_1024_SPEEDOFROTATION_OFFSET)/PCK_PT_1024_SPEEDOFROTATION_FACTOR))

/** The gain factor of the scaling of signal speedOfRotation of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_SPEEDOFROTATION_FACTOR	(0.1)

/** The offset of the scaling of signal speedOfRotation of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_SPEEDOFROTATION_OFFSET	(0.0)

/** The minimum of the world value of signal speedOfRotation of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_SPEEDOFROTATION_MIN	(0.0)

/** The maximum of the world value of signal speedOfRotation of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_SPEEDOFROTATION_MAX	(6500.0)

/** The minimum of the world value of signal sequenceCounter of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_SEQUENCECOUNTER_MIN	(0)

/** The maximum of the world value of signal sequenceCounter of frame StateEcu01 (1024, 0x400). */
#define PCK_PT_1024_SEQUENCECOUNTER_MAX	(14)

/** The minimum of the world value of signal checksum of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_CHECKSUM_MIN	(0)

/** The maximum of the world value of signal checksum of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_CHECKSUM_MAX	(255)

/** The minimum of the world value of signal sequenceCounter of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_SEQUENCECOUNTER_MIN	(15)

/** The maximum of the world value of signal sequenceCounter of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_SEQUENCECOUNTER_MAX	(1)


/** Convert the binary value of signal torque of frame StateEcu02 (1040, 0x410)
    as received via the CAN interface into the world value. */
#define PCK_PT_1040_TORQUE_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_1040_TORQUE_FACTOR+PCK_PT_1040_TORQUE_OFFSET)

/** Convert the world value of signal torque of frame StateEcu02 (1040, 0x410)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_1040_TORQUE_FLT_TO_BIN(flt) \
            ((int16_t)(((flt)-PCK_PT_1040_TORQUE_OFFSET)/PCK_PT_1040_TORQUE_FACTOR))

/** The gain factor of the scaling of signal torque of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_TORQUE_FACTOR	(0.5)

/** The offset of the scaling of signal torque of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_TORQUE_OFFSET	(0.0)

/** The minimum of the world value of signal torque of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_TORQUE_MIN	(-500.0)

/** The maximum of the world value of signal torque of frame StateEcu02 (1040, 0x410). */
#define PCK_PT_1040_TORQUE_MAX	(500.0)

/** The minimum of the world value of signal sequenceCounter of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_SEQUENCECOUNTER_MIN	(1)

/** The maximum of the world value of signal sequenceCounter of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_SEQUENCECOUNTER_MAX	(14)


/** Convert the binary value of signal minSpeedOfRotation of frame UserLimits (2032, 0x7f0)
    as received via the CAN interface into the world value. */
#define PCK_PT_2032_MINSPEEDOFROTATION_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_2032_MINSPEEDOFROTATION_FACTOR+PCK_PT_2032_MINSPEEDOFROTATION_OFFSET)

/** Convert the world value of signal minSpeedOfRotation of frame UserLimits (2032, 0x7f0)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_2032_MINSPEEDOFROTATION_FLT_TO_BIN(flt) \
            ((uint16_t)(((flt)-PCK_PT_2032_MINSPEEDOFROTATION_OFFSET)/PCK_PT_2032_MINSPEEDOFROTATION_FACTOR))

/** The gain factor of the scaling of signal minSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINSPEEDOFROTATION_FACTOR	(1.6)

/** The offset of the scaling of signal minSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINSPEEDOFROTATION_OFFSET	(0.0)

/** The minimum of the world value of signal minSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINSPEEDOFROTATION_MIN	(0.0)

/** The maximum of the world value of signal minSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINSPEEDOFROTATION_MAX	(6500.0)


/** Convert the binary value of signal maxSpeedOfRotation of frame UserLimits (2032, 0x7f0)
    as received via the CAN interface into the world value. */
#define PCK_PT_2032_MAXSPEEDOFROTATION_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_2032_MAXSPEEDOFROTATION_FACTOR+PCK_PT_2032_MAXSPEEDOFROTATION_OFFSET)

/** Convert the world value of signal maxSpeedOfRotation of frame UserLimits (2032, 0x7f0)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_2032_MAXSPEEDOFROTATION_FLT_TO_BIN(flt) \
            ((uint16_t)(((flt)-PCK_PT_2032_MAXSPEEDOFROTATION_OFFSET)/PCK_PT_2032_MAXSPEEDOFROTATION_FACTOR))

/** The gain factor of the scaling of signal maxSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXSPEEDOFROTATION_FACTOR	(1.6)

/** The offset of the scaling of signal maxSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXSPEEDOFROTATION_OFFSET	(0.0)

/** The minimum of the world value of signal maxSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXSPEEDOFROTATION_MIN	(0.0)

/** The maximum of the world value of signal maxSpeedOfRotation of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXSPEEDOFROTATION_MAX	(6500.0)

/** The minimum of the world value of signal checksum of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_CHECKSUM_MIN	(0)

/** The maximum of the world value of signal checksum of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_CHECKSUM_MAX	(255)


/** Convert the binary value of signal minPower of frame UserLimits (2032, 0x7f0)
    as received via the CAN interface into the world value. */
#define PCK_PT_2032_MINPOWER_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_2032_MINPOWER_FACTOR+PCK_PT_2032_MINPOWER_OFFSET)

/** Convert the world value of signal minPower of frame UserLimits (2032, 0x7f0)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_2032_MINPOWER_FLT_TO_BIN(flt) \
            ((uint16_t)(((flt)-PCK_PT_2032_MINPOWER_OFFSET)/PCK_PT_2032_MINPOWER_FACTOR))

/** The gain factor of the scaling of signal minPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINPOWER_FACTOR	(0.5)

/** The offset of the scaling of signal minPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINPOWER_OFFSET	(-10.0)

/** The minimum of the world value of signal minPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINPOWER_MIN	(-10.0)

/** The maximum of the world value of signal minPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MINPOWER_MAX	(240.0)


/** Convert the binary value of signal maxPower of frame UserLimits (2032, 0x7f0)
    as received via the CAN interface into the world value. */
#define PCK_PT_2032_MAXPOWER_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_2032_MAXPOWER_FACTOR+PCK_PT_2032_MAXPOWER_OFFSET)

/** Convert the world value of signal maxPower of frame UserLimits (2032, 0x7f0)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_2032_MAXPOWER_FLT_TO_BIN(flt) \
            ((uint16_t)(((flt)-PCK_PT_2032_MAXPOWER_OFFSET)/PCK_PT_2032_MAXPOWER_FACTOR))

/** The gain factor of the scaling of signal maxPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXPOWER_FACTOR	(0.5)

/** The offset of the scaling of signal maxPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXPOWER_OFFSET	(-10.0)

/** The minimum of the world value of signal maxPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXPOWER_MIN	(-10.0)

/** The maximum of the world value of signal maxPower of frame UserLimits (2032, 0x7f0). */
#define PCK_PT_2032_MAXPOWER_MAX	(240.0)

/** The minimum of the world value of signal checksum of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_CHECKSUM_MIN	(0)

/** The maximum of the world value of signal checksum of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_CHECKSUM_MAX	(255)

/** The minimum of the world value of signal sequenceCounter of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_SEQUENCECOUNTER_MIN	(0)

/** The maximum of the world value of signal sequenceCounter of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_SEQUENCECOUNTER_MAX	(14)


/** Convert the binary value of signal power of frame InfoPowerDisplay (1536, 0x600)
    as received via the CAN interface into the world value. */
#define PCK_PT_1536_POWER_BIN_TO_FLT(bin) \
            ((float)(bin)*PCK_PT_1536_POWER_FACTOR+PCK_PT_1536_POWER_OFFSET)

/** Convert the world value of signal power of frame InfoPowerDisplay (1536, 0x600)
    into the binary value as transmitted via the CAN interface. */
#define PCK_PT_1536_POWER_FLT_TO_BIN(flt) \
            ((uint16_t)(((flt)-PCK_PT_1536_POWER_OFFSET)/PCK_PT_1536_POWER_FACTOR))

/** The gain factor of the scaling of signal power of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_POWER_FACTOR	(32.0)

/** The offset of the scaling of signal power of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_POWER_OFFSET	(-500000.0)

/** The minimum of the world value of signal power of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_POWER_MIN	(-500000.0)

/** The maximum of the world value of signal power of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_POWER_MAX	(500000.0)

/** The minimum of the world value of signal state of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_STATE_MIN	(0)

/** The maximum of the world value of signal state of frame InfoPowerDisplay (1536, 0x600). */
#define PCK_PT_1536_STATE_MAX	(2)

/** The minimum of the world value of signal noDlcErrors of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_NODLCERRORS_MIN	(0)

/** The maximum of the world value of signal noDlcErrors of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_NODLCERRORS_MAX	(2047)

/** The minimum of the world value of signal noCheckSumErrors of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_NOCHECKSUMERRORS_MIN	(0)

/** The maximum of the world value of signal noCheckSumErrors of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_NOCHECKSUMERRORS_MAX	(2047)

/** The minimum of the world value of signal noSqcErrors of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_NOSQCERRORS_MIN	(0)

/** The maximum of the world value of signal noSqcErrors of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_NOSQCERRORS_MAX	(2047)

/** The minimum of the world value of signal sequenceCounter of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_SEQUENCECOUNTER_MIN	(1)

/** The maximum of the world value of signal sequenceCounter of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_SEQUENCECOUNTER_MAX	(126)

/** The minimum of the world value of signal checksum of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_CHECKSUM_MIN	(0)

/** The maximum of the world value of signal checksum of frame StatusPowerDisplay (1537, 0x601). */
#define PCK_PT_1537_CHECKSUM_MAX	(255)

/** The minimum of the world value of signal sequenceCounter of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_SEQUENCECOUNTER_MIN	(6)

/** The maximum of the world value of signal sequenceCounter of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_SEQUENCECOUNTER_MAX	(1)

/** The minimum of the world value of signal belowMinSpeedOfRotation of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_BELOWMINSPEEDOFROTATION_MIN	(0)

/** The maximum of the world value of signal belowMinSpeedOfRotation of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_BELOWMINSPEEDOFROTATION_MAX	(1)

/** The minimum of the world value of signal aboveMaxSpeedOfRotation of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_ABOVEMAXSPEEDOFROTATION_MIN	(0)

/** The maximum of the world value of signal aboveMaxSpeedOfRotation of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_ABOVEMAXSPEEDOFROTATION_MAX	(1)

/** The minimum of the world value of signal belowMinPower of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_BELOWMINPOWER_MIN	(0)

/** The maximum of the world value of signal belowMinPower of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_BELOWMINPOWER_MAX	(1)

/** The minimum of the world value of signal aboveMaxPower of frame LimitsPowerDisplay (1538, 0x602). */
#define PCK_PT_1538_ABOVEMAXPOWER_MIN	(0)

/** The maximum of the world value of signal aboveMaxPower of frame LimitsPowerDisplay (1538, 0x602). */
