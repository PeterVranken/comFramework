 ...
 * Some useful statistics about the CAN frames of cluster winSampleIntegration.
 *
...
#define CST_NO_CAN_FRAMES (0+(CST_NO_CAN_FRAMES_PT))

/** The number of sent CAN frames in the cluster. */
#define CST_NO_CAN_FRAMES_SENT (0+(CST_NO_CAN_FRAMES_SENT_PT))

/** The number of received CAN frames in the cluster. */
#define CST_NO_CAN_FRAMES_RECEIVED (0+(CST_NO_CAN_FRAMES_RECEIVED_PT))

/** The total number of affected CAN frames in bus PT, i.e. either sent or received. */
#define CST_NO_CAN_FRAMES_PT (0+1+1+1+1+1+1)

/** The number of sent CAN frames in bus PT. */
#define CST_NO_CAN_FRAMES_SENT_PT (0+1+1+1)

/** The number of received CAN frames in bus PT. */
#define CST_NO_CAN_FRAMES_RECEIVED_PT (0+1+1+1)
