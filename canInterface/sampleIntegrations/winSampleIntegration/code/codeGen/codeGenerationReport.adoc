= Code Generation Report for CAN Network winSampleIntegration
:Author:    comFramework - codeGenerator version 1.13.1 (https://github.com/PeterVranken/comFramework)
:toc:
:toclevels: 4
:xrefstyle: short
:numbered:
