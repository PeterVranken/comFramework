...
void pck_unpack_PT_LimitsPowerDisplay_1538(const uint8_t m[])
{
    ...
    pck_API_PT_LimitsPowerDisplay_1538.signals.belowMinSpeedOfRotation = (bool)(((uint8_t)(m[0] & 0x08)) >> 3);
    pck_API_PT_LimitsPowerDisplay_1538.signals.aboveMaxSpeedOfRotation = (bool)(((uint8_t)(m[0] & 0x10)) >> 4);
    pck_API_PT_LimitsPowerDisplay_1538.signals.belowMinPower = (bool)(((uint8_t)(m[0] & 0x20)) >> 5);
    pck_API_PT_LimitsPowerDisplay_1538.signals.aboveMaxPower = (bool)(((uint8_t)(m[0] & 0x40)) >> 6);
