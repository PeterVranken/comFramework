...
/** Check the definition of the checksum of frame frame_x2044 (2044, 0x7fc)
    on bus B1.\n
      A precondition for checksums is that they have eight Bit and are positioned at a byte
    position. */
#if CAP_B1_FRAME_X2044_X2044_CHECKSUM_LENGTH != 8               \
    || (!CAP_B1_FRAME_X2044_X2044_CHECKSUM_IS_BIG_ENDIAN        \
        && CAP_B1_FRAME_X2044_X2044_CHECKSUM_STARTBIT%8 != 0    \
        || CAP_B1_FRAME_X2044_X2044_CHECKSUM_IS_BIG_ENDIAN      \
           && CAP_B1_FRAME_X2044_X2044_CHECKSUM_STARTBIT%8 != 7 \
       )
# error Input file canBus_01.dbc, frame frame_x2044 (2044, 0x7fc): Checksums are supported only as an eight Bit integer on byte boundary
#endif
...
/** Check the definition of the checksum of frame frame_2047 (2047, 0x7ff)
    on bus B1.\n
      A precondition for checksums is that they have eight Bit and are positioned at a byte
    position. */
#if CAP_B1_FRAME_2047_2047_CHECKSUM_LENGTH != 8               \
    || (!CAP_B1_FRAME_2047_2047_CHECKSUM_IS_BIG_ENDIAN        \
        && CAP_B1_FRAME_2047_2047_CHECKSUM_STARTBIT%8 != 0    \
        || CAP_B1_FRAME_2047_2047_CHECKSUM_IS_BIG_ENDIAN      \
           && CAP_B1_FRAME_2047_2047_CHECKSUM_STARTBIT%8 != 7 \
       )
# error Input file canBus_01.dbc, frame frame_2047 (2047, 0x7ff): Checksums are supported only as an eight Bit integer on byte boundary
#endif
...
/** Check the definition of the checksum of frame frame_x0 (0, 0x000)
    on bus B1.\n
      A precondition for checksums is that they have eight Bit and are positioned at a byte
    position. */
#if CAP_B1_FRAME_X0_X0_CHECKSUM_LENGTH != 8               \
    || (!CAP_B1_FRAME_X0_X0_CHECKSUM_IS_BIG_ENDIAN        \
        && CAP_B1_FRAME_X0_X0_CHECKSUM_STARTBIT%8 != 0    \
        || CAP_B1_FRAME_X0_X0_CHECKSUM_IS_BIG_ENDIAN      \
           && CAP_B1_FRAME_X0_X0_CHECKSUM_STARTBIT%8 != 7 \
       )
# error Input file canBus_01.dbc, frame frame_x0 (0, 0x000): Checksums are supported only as an eight Bit integer on byte boundary
#endif
...
/** Check the definition of the checksum of frame frame_x2047 (2047, 0x7ff)
    on bus B1.\n
      A precondition for checksums is that they have eight Bit and are positioned at a byte
    position. */
#if CAP_B1_FRAME_X2047_X2047_CHECKSUM_LENGTH != 8               \
    || (!CAP_B1_FRAME_X2047_X2047_CHECKSUM_IS_BIG_ENDIAN        \
        && CAP_B1_FRAME_X2047_X2047_CHECKSUM_STARTBIT%8 != 0    \
        || CAP_B1_FRAME_X2047_X2047_CHECKSUM_IS_BIG_ENDIAN      \
           && CAP_B1_FRAME_X2047_X2047_CHECKSUM_STARTBIT%8 != 7 \
       )
# error Input file canBus_01.dbc, frame frame_x2047 (2047, 0x7ff): Checksums are supported only as an eight Bit integer on byte boundary
#endif
...
/** Check the definition of the checksum of frame frame_0 (0, 0x000)
    on bus B1.\n
      A precondition for checksums is that they have eight Bit and are positioned at a byte
    position. */
#if CAP_B1_FRAME_0_0_CHECKSUM_LENGTH != 8               \
    || (!CAP_B1_FRAME_0_0_CHECKSUM_IS_BIG_ENDIAN        \
        && CAP_B1_FRAME_0_0_CHECKSUM_STARTBIT%8 != 0    \
        || CAP_B1_FRAME_0_0_CHECKSUM_IS_BIG_ENDIAN      \
           && CAP_B1_FRAME_0_0_CHECKSUM_STARTBIT%8 != 7 \
       )
# error Input file canBus_01.dbc, frame frame_0 (0, 0x000): Checksums are supported only as an eight Bit integer on byte boundary
#endif
