...
srcDirList += code/ ../threadSafeQueue/src/
$(info testOfThreadSafeQueue.mk: Customized list of source folders for $(APP): $(srcDirList))

# This sample requires the floating point support for the standard I/O library (printf in
# the first place).
IO_FLOAT_LIB = 0
#$(info testOfThreadSafeQueue.mk: The application makes use of the stdio library without floating point support for printf & co)
