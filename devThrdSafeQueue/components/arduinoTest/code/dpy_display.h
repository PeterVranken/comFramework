...
public:
    ...
    /** Formatted printing the current number of test cycles. */
    void printNoCycles(uint32_t noCycles);

    /** Formatted printing the current number of test errors. */
    void printNoErrors(int16_t noErrors);
...
/** Formatted printing of the number of test cycles done so far.
      @remark C++ clients should not use this API but access the global object \a
    dpy_display instead. */
DPY_C_API void dpy_printNoCycles(uint32_t noCycles);

/** Formatted printing of the number of test errors seen so far.
      @remark C++ clients should not use this API but access the global object \a
    dpy_display instead. */
DPY_C_API void dpy_printNoErrors(int16_t noErrors);

/** Formatted printing of the current CPU load.
      @remark C++ clients should not use this API but access the global object \a
    dpy_display instead. */
